...
class mensagemDAO {
    ...
    public function exibirMensagem( $chat ) {
        try {
            ...
            $sql = "SELECT mensagem.*, usuario.nome, usuario.foto FROM mensagem JOIN usuario ON mensagem.remetente = usuario.id_usuario WHERE chat = ? ORDER BY idmensagem  LIMIT 10";
