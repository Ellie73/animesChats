...
<body style='background-color:#cccbcb'>
    ...
    <section class="flex">
        ...
        <aside>
            <section>
                <form action="../control/alterarSenha.php" method="POST">
                    ...
                    <table class="mb-3">
                        ...
                        <tr>
                            ...
                            <td><input type="password" id="senhacad" name="senha" required onkeyup="confereSenha()" minlength="5" class="form-control"></td>
                            <td><input type="password" id="confirmSenhacad" required onkeyup="confereSenha()" class="form-control"></td>
                        </tr>
                    </table>
