        ...
        <div class="container">
            <div class="table">
                <table>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-danger"><a href="?idcomunidade=<?= $comunidade["idcomunidade"] ?>" style="color:white;">Alterar</a></button>

                            </td>
                            <td>
                                <button class="btn btn-dark"><a href="../control/deletarComunidade.php?idcomunidade=<?= $comunidade["idcomunidade"] ?>&&nome=<?=$comunidade["nome"]?>" style="color:white;">Excluir</a></button>
                            </td>
                        </tr>
                    <?php
                    }
                ...
                <div style="margin: auto 45%;">
                    <button class="site-btn"><a href="./criarComunidade.php" style="color: #ffff;"> Criar uma nova Comunidade</a></button>
                </div>
            </div>
        </div>
